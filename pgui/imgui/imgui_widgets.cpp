...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	int text_size = Animate(label, "label_size", hovered, 120, 0.15, STATIC);
	...
	int alpha_active = Animate(label, "act", true, ItPLibrary2->second, 0.05, INTERP);
	...
	//background
	window->DrawList->AddRectFilled(bb.Min + ImVec2(1, 1), bb.Max - ImVec2(1, 1), ImColor(auto_red, auto_green, auto_blue, 20 + alpha_active), style.FrameRounding);
	//outline

	window->DrawList->AddRect(bb.Min, bb.Max, ImColor(auto_red, auto_green, auto_blue, 150 + text_size), style.FrameRounding);
...
bool ImGui::SubButton(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, int this_tab, int opened_tab)
{
	ImGuiWindow* window = GetCurrentWindow( );
	if (window->SkipItems)
		return false;
	...
	window->DrawList->AddRect(bb.Min, bb.Max, ImColor(auto_red, auto_green, auto_blue, 150 + alpha_active), style.FrameRounding);
...
bool ImGui::TabButton(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, int this_tab, int opened_tab)
{
	ImGuiWindow* window = GetCurrentWindow( );
	if (window->SkipItems)
		return false;
	...
	int hovered1 = Animate("button_hover", label, hovered, 100, 0.15, DYNAMIC);
	float alpha = Animate("button", label, this_tab == opened_tab, 200, 0.05, DYNAMIC);
	int selected_alpha = Animate("button_hovered", label, this_tab == opened_tab, 200, 0.15, DYNAMIC);
...
int ImGui::Checkbox(const char* label, bool* v)
{
	...
	int active_alpha = Animate(label, "active_alpha", *v, 255, 0.2, STATIC);
	int active_pad_modifer = Animate(label, "active_pad_modifer", *v, 255, 0.35, STATIC);
	int hovered_alpha2 = Animate(label, "hover_alpha", hovered, 50, 0.05, STATIC);
...
void ImGui::SeparatorEx(ImGuiSeparatorFlags flags)
{
	...
	else if (flags & ImGuiSeparatorFlags_Horizontal)
	{
		...
		const ImRect bb(ImVec2(x1 + 12, window->DC.CursorPos.y), ImVec2(x2 - 15, window->DC.CursorPos.y + thickness_draw));
...
bool ImGui::DragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
	...
	switch (data_type)
	{
		case ImGuiDataType_S8:
		{
			ImS32 v32 = (ImS32) * (ImS8*) p_v;  bool r = DragBehaviorT<ImS32, ImS32, float>(ImGuiDataType_S32, &v32, v_speed, p_min ? *(const ImS8*) p_min : IM_S8_MIN, p_max ? *(const ImS8*) p_max : IM_S8_MAX, format, flags); if (r) *(ImS8*) p_v = (ImS8) v32; return r;
		}
		case ImGuiDataType_U8:
		{
			ImU32 v32 = (ImU32) * (ImU8*) p_v;  bool r = DragBehaviorT<ImU32, ImS32, float>(ImGuiDataType_U32, &v32, v_speed, p_min ? *(const ImU8*) p_min : IM_U8_MIN, p_max ? *(const ImU8*) p_max : IM_U8_MAX, format, flags); if (r) *(ImU8*) p_v = (ImU8) v32; return r;
		}
		case ImGuiDataType_S16:
		{
			ImS32 v32 = (ImS32) * (ImS16*) p_v; bool r = DragBehaviorT<ImS32, ImS32, float>(ImGuiDataType_S32, &v32, v_speed, p_min ? *(const ImS16*) p_min : IM_S16_MIN, p_max ? *(const ImS16*) p_max : IM_S16_MAX, format, flags); if (r) *(ImS16*) p_v = (ImS16) v32; return r;
		}
		case ImGuiDataType_U16:
		{
			ImU32 v32 = (ImU32) * (ImU16*) p_v; bool r = DragBehaviorT<ImU32, ImS32, float>(ImGuiDataType_U32, &v32, v_speed, p_min ? *(const ImU16*) p_min : IM_U16_MIN, p_max ? *(const ImU16*) p_max : IM_U16_MAX, format, flags); if (r) *(ImU16*) p_v = (ImU16) v32; return r;
		}
...
bool ImGui::SliderBehavior(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb)
{
	...
	switch (data_type)
	{
		case ImGuiDataType_S8:
		{
			ImS32 v32 = (ImS32) * (ImS8*) p_v;  bool r = SliderBehaviorT<ImS32, ImS32, float>(bb, id, ImGuiDataType_S32, &v32, *(const ImS8*) p_min, *(const ImS8*) p_max, format, flags, out_grab_bb); if (r) *(ImS8*) p_v = (ImS8) v32;  return r;
		}
		case ImGuiDataType_U8:
		{
			ImU32 v32 = (ImU32) * (ImU8*) p_v;  bool r = SliderBehaviorT<ImU32, ImS32, float>(bb, id, ImGuiDataType_U32, &v32, *(const ImU8*) p_min, *(const ImU8*) p_max, format, flags, out_grab_bb); if (r) *(ImU8*) p_v = (ImU8) v32;  return r;
		}
		case ImGuiDataType_S16:
		{
			ImS32 v32 = (ImS32) * (ImS16*) p_v; bool r = SliderBehaviorT<ImS32, ImS32, float>(bb, id, ImGuiDataType_S32, &v32, *(const ImS16*) p_min, *(const ImS16*) p_max, format, flags, out_grab_bb); if (r) *(ImS16*) p_v = (ImS16) v32; return r;
		}
		case ImGuiDataType_U16:
		{
			ImU32 v32 = (ImU32) * (ImU16*) p_v; bool r = SliderBehaviorT<ImU32, ImS32, float>(bb, id, ImGuiDataType_U32, &v32, *(const ImU16*) p_min, *(const ImU16*) p_max, format, flags, out_grab_bb); if (r) *(ImU16*) p_v = (ImU16) v32; return r;
		}
		case ImGuiDataType_S32:
...
int colorConverterGetR(int hexValue)
{
	auto r = ((hexValue >> 16) & 0xFF) / 255.0;
	return r;
}
int colorConverterGetG(int hexValue)
{
	auto g = ((hexValue >> 8) & 0xFF) / 255.0;
	return g;
}
int colorConverterGetB(int hexValue)
{
	auto b = ((hexValue) & 0xFF) / 255.0;
	return b;
}
...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
	...
	{
		std::stringstream clip_str; clip_str << rgb2hex(int(col[0] * 255.f), int(col[1] * 255.f), int(col[2] * 255.f), true);
	...
	if (alpha_bar)
	{
		...
		ImRect bar1_bb(bar1_pos_x - 168, picker_pos.y + 148, bar1_pos_x - 168 + sv_picker_size, picker_pos.y + bars_width + 148);
...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, const ImVec2& size_arg)
{
	...
	const float default_size = GetFrameHeight( );
	const ImVec2 size(size_arg.x == 0.0f ? default_size - 4 : size_arg.x - 4, size_arg.y == 0.0f ? default_size - 4 : size_arg.y - 4);
	const ImRect bb(window->DC.CursorPos, window->DC.CursorPos + size);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
	...
	const ImVec2 text_min = pos + ImVec2(3, 0);

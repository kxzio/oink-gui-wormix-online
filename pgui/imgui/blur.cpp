...
inline void DrawBackgroundBlur(ImDrawList* drawList, IDirect3DDevice9* device, float alpha)
{
    ...
    drawList->AddImageRounded(blurTexture, { 0.0f, 0.0f }, { backbufferWidth * 1.0f, backbufferHeight * 1.0f }, { 0.0f, 0.0f }, { 1.0f, 1.0f }, ImGui::GetColorU32(ImVec4(1.f, 1.f, 1.f, alpha)), 0);
}
